...
def run_epoch(
    ...
    for batch_idx, (images, color_features, targets) in enumerate(loader):
        ...
        if (batch_idx + 1) % 10 == 0 or (batch_idx + 1) == num_batches:
            ...
            print(f"\r[{batch_idx + 1:3d}/{num_batches:3d}] Loss: {current_loss:.4f} | Acc: {current_acc:.1%} | Progress: {progress:5.1f}%", end="", flush=True)
